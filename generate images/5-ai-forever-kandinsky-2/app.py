...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs = []
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/NsOpfQRos43e40IzSq4SY7NTtxGodmSWo1m74K17SVpoUzuQA/out.png'))
    ...
    def run_process(input1,input2,input3,input4,input5,input6,input7, input8, input9):
       ...
       body = {
            ...
            "input": {
                "prompt": input1,
                "num_inference_steps": input2,
                "guidance_scale": input3,
                "scheduler": input4,
                "prior_cf_scale": input5,
                "prior_steps": input6,
                "width": input7,
                "height": input8,
                "batch_size": input9
       ...
       if response.status_code == 201:
            ...
            if output:
                  if len(output) == 1:
                     return  gr.Image(value=output), gr.Image(),gr.Image(),gr.Image()
    ...
    def cancel_process(input1,input2,input3,input4,input5,input6,input7, input8, input9):
           global cancel_url
           cancel_url = "123"
           return gr.Image(value='https://replicate.delivery/pbxt/NsOpfQRos43e40IzSq4SY7NTtxGodmSWo1m74K17SVpoUzuQA/out.png'), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
