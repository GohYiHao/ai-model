...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs = []
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/U3btgZ7c4aoRPFC0W9uym5hEDFsephSg8i2sGecvN3c2KBbSA/out-0.png'))
    ...
    def cancel_process(input1,input2,input3,input4,input5,input6,input7, input8, input9,input10,input11,input12, input13,input14):
           global cancel_url
           cancel_url='123'
           return gr.Image(value='https://replicate.delivery/pbxt/U3btgZ7c4aoRPFC0W9uym5hEDFsephSg8i2sGecvN3c2KBbSA/out-0.png'), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
