...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs = []
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/WgkUBmQLbkqnFtoe6sCBFBjRNc8m034yKr3wfffOWzTCxvfPC/output0.png'))
    ...
    def run_process(input1,input2,input3,input4,input5,input6,input7, input8, input9):
       ...
       body = {
        ...
        "input": {
           ...
           "masactrl_start_step": input7,
           "masactrl_start_layer": input8,
           "seed": input9
        }
        }
    ...
    def cancel_process(input1,input2,input3,input4,input5,input6,input7, input8, input9):
           global cancel_url
           cancel_url = '123'
           return gr.Image(value='https://replicate.delivery/pbxt/WgkUBmQLbkqnFtoe6sCBFBjRNc8m034yKr3wfffOWzTCxvfPC/output0.png'), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
