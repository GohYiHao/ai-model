...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs = []
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/aOZ4ywUeyeiyqEz5l7lixq0e5rAbs3qTStetOGXNKZd4g6QEB/out-0.png'))
    ...
    def run_process(input1,input2,input3,input4,input5,input6,input7, input8, input9,input10,input11,input12):
       global cancel_url
       cancel_url = ''
           ...
           if input4:
                  body = {
                    ...
                    "input": {
                       "task": input1,
                       "prompt": input2,
                       "negative_prompt": input3,
                       "image":  data_uri_image,
                       "strength": input5,
                       "width": input6,
                       "height": input7,
                       "num_outputs": input8,
                       "num_steps_prior": input9,
    ...
    def cancel_process(input1,input2,input3,input4,input5,input6,input7, input8, input9,input10,input11,input12):
           global cancel_url
           cancel_url='123'
           return gr.Image(value='https://replicate.delivery/pbxt/aOZ4ywUeyeiyqEz5l7lixq0e5rAbs3qTStetOGXNKZd4g6QEB/out-0.png'), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
