...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs = []
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/jPiwHtgNYgrFPtoXfJeeWKiDRX6sGfyCp3c8yXEZBobevNASC/ComfyUI_00001_.png'))
    ...
    def run_process(input1,input2,input3,input4,input5,input6,input7, input8, input9, input10, input11, input12):
       ...
       body = {
        ...
        "input": {
            ...
            "model": input3,
            "num_inference_steps": input4,
            "guidance_scale": input5,
            "seed": input6,
            "width": input7,
            "height": input8,
            "num_outputs": input9,
            "sampler_name": input10,
            "scheduler": input11,
    ...
    def cancel_process(input1,input2,input3,input4,input5,input6,input7, input8, input9, input10, input11, input12):
           global cancel_url
           cancel_url ="123"
           return gr.Image(value='https://replicate.delivery/pbxt/jPiwHtgNYgrFPtoXfJeeWKiDRX6sGfyCp3c8yXEZBobevNASC/ComfyUI_00001_.png'), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
