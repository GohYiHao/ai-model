...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs = []
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/eVMzXJerAzpqnErNJ9P4ncWmd2d3OkGA31DKhG3ElQhLMIbRA/output.png'))
    ...
    def cancel_process(input1,input2,input3,input4,input5,input6,input7, input8):
           global cancel_url
           cancel_url ="123"
           return gr.Image(value='https://replicate.delivery/pbxt/eVMzXJerAzpqnErNJ9P4ncWmd2d3OkGA31DKhG3ElQhLMIbRA/output.png'), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
