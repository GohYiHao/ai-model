...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs = []
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/oDtYIK2lDoaKMtdE4E5ozQSa61BU3gc4aRvGF3xmFpdwCxbE/out-0.png'))
    ...
    def run_process(input1,input2,input3,input4,input5,input6,input7,input8, input9, input10, input11, input12, input13, input14, input15, input16):
       global cancel_url
       cancel_url=''
       ...
       if input2:
            ...
            "input": {
                ...
                "image" : data_uri_mask,
                "img2img": input3,
                "condition_scale": input4,
                "strength": input5,
                "negative_prompt": input6,
    ...
    def cancel_process(input1,input2,input3,input4,input5,input6,input7,input8, input9, input10, input11, input12, input13, input14, input15, input16):
        global cancel_url
        cancel_url = '123'
        return gr.Image(value='https://replicate.delivery/pbxt/oDtYIK2lDoaKMtdE4E5ozQSa61BU3gc4aRvGF3xmFpdwCxbE/out-0.png'), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
