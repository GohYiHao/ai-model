...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs = []
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/xs0pPOUM6HKmPlJJBXqKfE1YsiMzgNsCuGedlX0VqvPYifLgA/out-0.png'))
    ...
    def cancel_process(input1,input2,input3,input4,input5,input6,input7, input8, input9,input10,input11,input12):
           global cancel_url
           cancel_url= '123'
           return gr.Image(value='https://replicate.delivery/pbxt/xs0pPOUM6HKmPlJJBXqKfE1YsiMzgNsCuGedlX0VqvPYifLgA/out-0.png'), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
