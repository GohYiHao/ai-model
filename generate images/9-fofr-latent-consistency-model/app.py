...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs = []
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/LF23xWrMie2vMCmbiswetET2BLperpEtNodZSN4yNfDkAClHB/out-0.jpg'))
           ...
           if input5:
                  body = {
                    ...
                    "input": {
                        ...
                        "width": input2,
                        "height": input3,
                        "sizing_strategy": input4,
                        "image":  data_uri_image,
                        "prompt_strength": input6,
                        "num_images": input7,
                        "num_inference_steps": input8,
                        "guidance_scale": input9,
                        "lcm_origin_steps": input10,
                        "seed": input11,
                        "control_image":  data_uri_mask,
                        "controlnet_conditioning_scale": input13,
                        "control_guidance_start": input14,
                        "control_guidance_end": input15,
                        "canny_low_threshold": input16,
                        "canny_high_threshold": input17,
                    }
                    }
           else:
                body = {
    ...
    def cancel_process(input1,input2,input3,input4,input5,input6,input7, input8, input9,input10,input11, input12, input13,input14, input15, input16, input17, intput18, input19):
           global cancel_url
           cancel_url = "123"
           return gr.Image(value='https://replicate.delivery/pbxt/LF23xWrMie2vMCmbiswetET2BLperpEtNodZSN4yNfDkAClHB/out-0.jpg'), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
