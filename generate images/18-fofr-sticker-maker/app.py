...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs = []
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/WZU3KPmCsg4QFFmzdgCefhyirgoyzbzXBA0ADbediYtvrIzkA/ComfyUI_00001_.png'))
    ...
    def cancel_process(input1,input2,input3,input4,input5,input6,input7, input8):
           global cancel_url
           cancel_url='123'
           return gr.Image(value='https://replicate.delivery/pbxt/WZU3KPmCsg4QFFmzdgCefhyirgoyzbzXBA0ADbediYtvrIzkA/ComfyUI_00001_.png'), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
