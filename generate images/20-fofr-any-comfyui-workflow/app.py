...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs = []
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/GvpKN1SsGJaLBdhZpWyOasslCMq1UeetKDf5l0wshxex5J4IB/ComfyUI_00001_.png'))
    ...
    def run_process(input1,input2,input3,input4):
       ...
       if input2:
                ...
                "version": version,
                "input": {
                    "workflow_json": input1,
                    "input_file": data_uri_image,
                    "return_temp_files": input3,
                    "randomise_seeds": input4
                }
                }
       else:
                body = {
    ...
    def cancel_process(input1,input2,input3,input4):
           return gr.Image(value='https://replicate.delivery/pbxt/GvpKN1SsGJaLBdhZpWyOasslCMq1UeetKDf5l0wshxex5J4IB/ComfyUI_00001_.png'), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
