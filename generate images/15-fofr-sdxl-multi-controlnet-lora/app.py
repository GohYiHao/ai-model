...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs = []
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/8486bdfefoHlkpbI4m98dnsm2azyIgIB8MVq3ilVpBgwdi0jA/control-0.png'))
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/GR5kmreA4fjf9JZIFh0GhIoEGEnJj6SmwYTszYVezXWm7EpHB/out-0.png'))
            outputs.append(gr.Image(visible=False))
            outputs.append(gr.Image(visible=False))
            
           
    
    def run_process(input1,input2,input3,input4,input5,input6,input7, input8, input9,input10,input11,input12, input13,input14, input15, input16, input17, input18, 
                    input19, input20,input21,input22,input23,input24, input25, input26, input27, input28, input29, input30, input31, input32, input33, input34):
       global cancel_url
       cancel_url = ''
           ...
           if input21:
                  body = {
                    ...
                    "input": {
                        ...
                        "width": input5,
                        "height": input6,   
                        "sizing_strategy": input7,  
                        "num_outputs": input8,
                        "scheduler": input9,
                        "num_inference_steps": input10,
                        "guidance_scale": input11,
                        "prompt_strength":input12,
                        "seed": input13,
                        "refine": input14,
                        "refine_steps": input15,
                        "lora_scale": input17,
                        "controlnet_1": input20,
                        "controlnet_1_image": data_uri_mask ,
                       "controlnet_1_conditioning_scale": input22,
                       "controlnet_1_start": input23,
                       "controlnet_1_end":input24,
                    }
                    }
           else:
                 body = {
    ...
    def cancel_process(input1,input2,input3,input4,input5,input6,input7, input8, input9,input10,input11,input12, input13,input14, input15, input16, input17, input18, 
                    input19, input20,input21,input22,input23,input24, input25, input26, input27, input28, input29, input30, input31, input32, input33, input34):
           global cancel_url
           cancel_url ='123'
           return gr.Image(value='https://replicate.delivery/pbxt/8486bdfefoHlkpbI4m98dnsm2azyIgIB8MVq3ilVpBgwdi0jA/control-0.png'), gr.Image(value='https://replicate.delivery/pbxt/GR5kmreA4fjf9JZIFh0GhIoEGEnJj6SmwYTszYVezXWm7EpHB/out-0.png'),gr.Image(visible=False),gr.Image(visible=False)
