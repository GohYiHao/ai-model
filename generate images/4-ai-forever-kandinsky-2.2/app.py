...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs = []
            outputs.append(gr.Image(value='https://replicate.delivery/pbxt/Lca3IEjcKoJBBVS6ajROkK37sDzPsmjYxIcFzxPZp65wZzTE/out-0.png'))
    ...
    def run_process(input1,input2,input3,input4,input5,input6,input7, input8):
       ...
       body = {
            ...
            "input": {
                ...
                "width": input3,
                "height": input4,
                "num_inference_steps": input5,
                "num_inference_steps_prior": input6,
                "num_outputs": input7,
                "seed": input8,
            }
            }
    ...
    def cancel_process(input1,input2,input3,input4,input5,input6,input7, input8):
           return gr.Image(value='https://replicate.delivery/pbxt/Lca3IEjcKoJBBVS6ajROkK37sDzPsmjYxIcFzxPZp65wZzTE/out-0.png'), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
