...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs.append(gr.Image(value="https://replicate.delivery/mgxm/4c20b80a-2bd3-4d75-8483-d5b1e2413b08/out.jpg"))
    ...
    def run_process(input1,input2,input3,input4,input5):
       ...
       if response.status_code == 201:
            ...
            if output:
                  if len(output) == 1:
                     return  gr.Image(value=output[0].get("file", '')), gr.Image(),gr.Image(),gr.Image()
                  elif len(output) == 2:
    ...
    def cancel_process(input1,input2,input3,input4,input5):
        ...
        cancel_url = '123'
        global output_image
        return gr.Image(value="https://replicate.delivery/mgxm/4c20b80a-2bd3-4d75-8483-d5b1e2413b08/out.jpg"), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
