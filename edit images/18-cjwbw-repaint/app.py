...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs.append(gr.Image(value="https://replicate.delivery/mgxm/3def0284-0a1b-4482-83b6-2e01adfa18e9/mask.png"))
            outputs.append(gr.Image(value="https://replicate.delivery/mgxm/c198394c-a879-48f4-9b18-7e406f30bec8/inpaint.png"))
            outputs.append(gr.Image(value="https://replicate.delivery/mgxm/136f4904-fb3b-420f-83a5-29510b02c6ce/masked_image.png"))
    ...
    def run_process(input1, input2, input3, input4):
       ...
       if response.status_code == 201:
            ...
            print(output,'333')
            if output:
                     return  gr.Image(value=output.get("mask", '')), gr.Image(value=output.get("inpaint", '')),gr.Image(value=output.get("masked_image", '')),gr.Image()
                
       return gr.Image(),gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
    
    def cancel_process(input1, input2, input3, input4):
        global cancel_url
        cancel_url = '123'
        global output_image
        return gr.Image(value="https://replicate.delivery/mgxm/3def0284-0a1b-4482-83b6-2e01adfa18e9/mask.png"), gr.Image(value="https://replicate.delivery/mgxm/c198394c-a879-48f4-9b18-7e406f30bec8/inpaint.png"),gr.Image(value="https://replicate.delivery/mgxm/136f4904-fb3b-420f-83a5-29510b02c6ce/masked_image.png"),gr.Image(visible=False)
