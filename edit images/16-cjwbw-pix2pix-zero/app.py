...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            outputs.append(gr.Image("https://replicate.delivery/pbxt/smBWUZbfhlWJKyZLRaV5TvLjagHaIpGjdOuZo7WPcUz0irOIA/edit.png"))
    ...
    def run_process(input1,input2,input3,input4,input5,input6):
       ...
       if response.status_code == 201:
            ...
            if output:
                     ...
                     return  gr.Image(value=output.get("edited_image",'https://replicate.delivery/pbxt/smBWUZbfhlWJKyZLRaV5TvLjagHaIpGjdOuZo7WPcUz0irOIA/edit.png')), gr.Image(),gr.Image(),gr.Image()
    ...
    def cancel_process(input1,input2,input3,input4,input5,input6):
        ...
        cancel_url = '123'
        global output_image
        return gr.Image(value="https://replicate.delivery/pbxt/smBWUZbfhlWJKyZLRaV5TvLjagHaIpGjdOuZo7WPcUz0irOIA/edit.png"), gr.Image(visible=False),gr.Image(visible=False),gr.Image(visible=False)
